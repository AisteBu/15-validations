...
test('vidurkis, kai duotas ne array: string', () => {
    expect(average('sded')).toBe(false);
})
...
test('vidurkis, kai ignoruojami array esantys string', () => {
    expect(average([8, 'a', 6])).toBe(7);
})

test('vidurkis, kai ignoruojami array esantys boolean', () => {
...
test('vidurkis, kai ignoruojami array esantys NaN', () => {
    expect(average([8, NaN, 6])).toBe(7);
})

test('vidurkis, kai ignoruojami array esantys []', () => {
...
test('vidurkis, kai ignoruojami array esantys null', () => {
    expect(average([8, null, 6])).toBe(7);
})

test('vidurkis, kai ignoruojami array esantys undefined', () => {
    expect(average([8, undefined, 6])).toBe(7);
})

test('vidurkis, kai ignoruojami array esantys function', () => {
